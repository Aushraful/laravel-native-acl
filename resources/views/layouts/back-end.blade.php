...
<head>
    ...
    <!-- DataTables -->
    <link rel="stylesheet" href="{{asset('back-end/bower_components/datatables.net-bs/css/dataTables.bootstrap.min.css')}}">
    <!-- Theme style -->
...
<div class="wrapper">
    ...
    <header class="main-header">
        <!-- Logo -->
        <a href="back-end/index2.html" class="logo">
    ...
    <!-- =============================================== -->
            ...
            <section class="sidebar">
                ...
                <ul class="sidebar-menu" data-widget="tree">
                    ...
                    @if(Auth::user())
                        ...
                        <li class="@yield('user-nav')"><a href="/users"><i class="fa fa-circle-o text-green"></i> <span>Users</span></a></li>
                        <li class="@yield('role-nav')"><a href="/roles"><i class="fa fa-circle-o text-yellow"></i> <span>Roles</span></a></li>
                        <li class="@yield('permission-nav')"><a href="/permissions"><i class="fa fa-circle-o text-red"></i> <span>Permissions</span></a></li>

                        <li class="treeview @yield('authorization-nav')">
                            <a href="#">
                                <i class="fa fa-lock text-blue"></i> <span>Authorization</span>
                                <span class="pull-right-container">
                                  <i class="fa fa-angle-left pull-right"></i>
                                </span>
                            </a>
                            <ul class="treeview-menu">
                                <li class="@yield('assign-role')"><a href="/assign-user-role"><i class="fa fa-user-plus text-yellow"></i> Assign User Role</a></li>
                                <li class="treeview @yield('assign-permission')">
                                    <a href="#"><i class="fa fa-key text-red"></i> Assign Permission
                                        <span class="pull-right-container">
                                          <i class="fa fa-angle-left pull-right"></i>
                                        </span>
                                    </a>
                                    <ul class="treeview-menu">
                                        <li class="@yield('assign-role-permission')"><a href="/assign-role-permission"><i class="fa fa-circle-o text-blue"></i> Role Permission</a></li>
                                        <li class="@yield('assign-user-permission')"><a href="/assign-user-permission"><i class="fa fa-circle-o text-blue"></i> User Permission</a></li>
                                    </ul>
                                </li>
                            </ul>
                        </li>
        ...
        <div class="content-wrapper">
            ...
            <section class="content-header" style="background: #fff !important; padding-bottom: 15px;">
